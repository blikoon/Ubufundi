/*
            This example app is designed to work with app5100provider.Make sure you check it out.

            #Read the settings exposed by other apps through ContentProvider
            #Request appropriate permissions
            #Use getContentResolver() to read the properties exposed by ContentProviders and show
             the data in different ui components
            #We can even start an activity that lives in another app to modify the settings.

 */

package com.blikoon.app5100consumer;
...
public class MainActivity extends Activity implements CompoundButton.OnCheckedChangeListener {
    ...
    public static final String SETTINGS_ACTION = "com.blikoon.app5100provider.ACTION_SETTINGS";
    public static final Uri SETTINGS_CONTENT_URI =
            Uri.parse("content://com.blikoon.app5100provider.settingsprovider/settings");
